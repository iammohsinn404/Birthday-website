...
(() => {
    ...
    function tick(now) {
        ...
        glowCursor.style.transform =
            `translate(${arrowX}px, ${arrowY}px)`;
        ...
        glowCursorTail.style.opacity =
            (stretch * 0.85).toFixed(2);

        glowCursorTail.style.transform =
            `rotate(${angle}rad) scaleX(${(
                0.45 +
                stretch * 1.6
            ).toFixed(2)})`;
        ...
        glowCursorRing.style.transform =
